...
const Header = () => {
  ...
  return (
    <div className='sticky z-10 header top-0 text-3xl flex justify-between items-center text-orange-500 font-bold p-3 border-b-2 border-orange-600'>
      ...
      :
      <Link to={'/login'}><h1 className='text-lg bg-green-500 cursor-pointer flex items-center border-solid border-2 border-black'>
